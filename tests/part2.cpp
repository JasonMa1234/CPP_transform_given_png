...
//   std::cout << "center pixel" << std::endl;

//   std::cout << png.getPixel(100, 50).l << std::endl;
//   std::cout << result.getPixel(100, 50).l << std::endl;

//   std::cout << "80% dark pixel >160 pixels away" << std::endl;
//   std::cout << png.getPixel(320, 50).l * 0.2 << std::endl;
//   std::cout << result.getPixel(320, 50).l << std::endl;

//   std::cout << "20 pixels away from center" << std::endl;
//     std::cout << png.getPixel(100, 50 + 20).l * 0.9 << std::endl;
//     std::cout << result.getPixel(100, 50 + 20).l << std::endl;
